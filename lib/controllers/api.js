...
exports.getIP = function (req, res,next) {
    ...
    if (!ip){
        ...
        //ip='37.57.5.247';
    }     // закомменторовать при snapshot
    //return res.json({country_code: 'UA'}); // раскомменторовать при snapshot
            ...
            /*if(fs.existsSync(pref)){
                ...
                phantom.create(function(err, ph) {
                    return ph.createPage(function(err, page) {
                        return page.open("http://localhost:8808/" + fullPath, function(status) {
                            console.log(status);
